...
import { Edit3, Trash2, Download, Sparkles } from 'lucide-react'
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 transition-opacity group-hover:opacity-100">
            ...
            <div className="absolute top-2 right-2 flex gap-1">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button size="icon-sm" variant="secondary" className="h-7 w-7 bg-white/20 backdrop-blur-sm hover:bg-white/30 border-0" onClick={(e) => handleDownload(e, image)}>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button size="icon-sm" variant="secondary" className="h-7 w-7 bg-white/20 backdrop-blur-sm hover:bg-red-500/50 border-0" onClick={(e) => handleDelete(e, image)}>
